...
public class CircularSeekBar extends View {
	...
	private void initAttributes(TypedArray attrArray) {
		mCircleXRadius = (float) (attrArray.getFloat(com.android.inrmeter.activity.R.styleable.CircularSeekBar_circle_x_radius, DEFAULT_CIRCLE_X_RADIUS) * DPTOPX_SCALE);
		mCircleYRadius = (float) (attrArray.getFloat(com.android.inrmeter.activity.R.styleable.CircularSeekBar_circle_y_radius, DEFAULT_CIRCLE_Y_RADIUS) * DPTOPX_SCALE);
		mPointerRadius = (float) (attrArray.getFloat(com.android.inrmeter.activity.R.styleable.CircularSeekBar_pointer_radius, DEFAULT_POINTER_RADIUS) * DPTOPX_SCALE);
		mPointerHaloWidth = (float) (attrArray.getFloat(com.android.inrmeter.activity.R.styleable.CircularSeekBar_pointer_halo_width, DEFAULT_POINTER_HALO_WIDTH) * DPTOPX_SCALE);
		mPointerHaloBorderWidth = (float) (attrArray.getFloat(com.android.inrmeter.activity.R.styleable.CircularSeekBar_pointer_halo_border_width, DEFAULT_POINTER_HALO_BORDER_WIDTH) * DPTOPX_SCALE);
		mCircleStrokeWidth = (float) (attrArray.getFloat(com.android.inrmeter.activity.R.styleable.CircularSeekBar_circle_stroke_width, DEFAULT_CIRCLE_STROKE_WIDTH) * DPTOPX_SCALE);

		String tempColor = attrArray.getString(com.android.inrmeter.activity.R.styleable.CircularSeekBar_pointer_color);
		if (tempColor != null) {
			try {
		...
		tempColor = attrArray.getString(com.android.inrmeter.activity.R.styleable.CircularSeekBar_pointer_halo_color);
		if (tempColor != null) {
			try {
		...
		tempColor = attrArray.getString(com.android.inrmeter.activity.R.styleable.CircularSeekBar_pointer_halo_color_ontouch);
		if (tempColor != null) {
			try {
		...
		tempColor = attrArray.getString(com.android.inrmeter.activity.R.styleable.CircularSeekBar_circle_color);
		if (tempColor != null) {
			try {
		...
		tempColor = attrArray.getString(com.android.inrmeter.activity.R.styleable.CircularSeekBar_circle_progress_color);
		if (tempColor != null) {
			try {
		...
		tempColor = attrArray.getString(com.android.inrmeter.activity.R.styleable.CircularSeekBar_circle_fill);
		if (tempColor != null) {
			try {
		...
		mPointerAlphaOnTouch = attrArray.getInt(com.android.inrmeter.activity.R.styleable.CircularSeekBar_pointer_alpha_ontouch, DEFAULT_POINTER_ALPHA_ONTOUCH);
		if (mPointerAlphaOnTouch > 255 || mPointerAlphaOnTouch < 0) {
			mPointerAlphaOnTouch = DEFAULT_POINTER_ALPHA_ONTOUCH;
		}

		mMax = attrArray.getInt(com.android.inrmeter.activity.R.styleable.CircularSeekBar_max, DEFAULT_MAX);
		mProgress = attrArray.getInt(com.android.inrmeter.activity.R.styleable.CircularSeekBar_progress, DEFAULT_PROGRESS);
		mCustomRadii = attrArray.getBoolean(com.android.inrmeter.activity.R.styleable.CircularSeekBar_use_custom_radii, DEFAULT_USE_CUSTOM_RADII);
		mMaintainEqualCircle = attrArray.getBoolean(com.android.inrmeter.activity.R.styleable.CircularSeekBar_maintain_equal_circle, DEFAULT_MAINTAIN_EQUAL_CIRCLE);
		mMoveOutsideCircle = attrArray.getBoolean(com.android.inrmeter.activity.R.styleable.CircularSeekBar_move_outside_circle, DEFAULT_MOVE_OUTSIDE_CIRCLE);
        lockEnabled = attrArray.getBoolean(com.android.inrmeter.activity.R.styleable.CircularSeekBar_lock_enabled, DEFAULT_LOCK_ENABLED);

		// Modulo 360 right now to avoid constant conversion
		mStartAngle = ((360f + (attrArray.getFloat((com.android.inrmeter.activity.R.styleable.CircularSeekBar_start_angle), DEFAULT_START_ANGLE) % 360f)) % 360f);
		mEndAngle = ((360f + (attrArray.getFloat((com.android.inrmeter.activity.R.styleable.CircularSeekBar_end_angle), DEFAULT_END_ANGLE) % 360f)) % 360f);
	...
	private void init(AttributeSet attrs, int defStyle) {
		final TypedArray attrArray = getContext().obtainStyledAttributes(attrs, com.android.inrmeter.activity.R.styleable.CircularSeekBar, defStyle, 0);
